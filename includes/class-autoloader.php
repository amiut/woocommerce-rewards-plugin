 ...
 * Class Autoloader
 *
 * @package CustomerRewards/Autoloader
 * @since   1.0
 */
...
class AutoLoader
{
	...
	public function __construct() {
        ...
        $this->include_path = untrailingslashit( plugin_dir_path( DWEB_REWARDS_PLUGIN_FILE ) ) . '/includes/';
	...
	protected function get_file_name_from_class( $class ) {
        $prefix = 'Dornaweb\\CustomerRewards\\';
