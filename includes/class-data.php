<?php
/**
 * CustomerRewards Entry Data Class
 *
...
abstract class Data
{
	...
	public function save() {
		 ...
		 */
		do_action( 'dweb_cr_before_' . $this->object_type . '_object_save', $this, $this->data_store );
		 ...
		 * @param DATA_Store_WP $data_store THe data store persisting the data.
		 */
		do_action( 'dweb_cr_after_' . $this->object_type . '_object_save', $this, $this->data_store );
	...
	public static function generate_meta_cache_key( $id, $cache_group ) {
		return Cache_Helper::get_cache_prefix( $cache_group ) . Cache_Helper::get_cache_prefix( 'object_' . $id ) . 'object_meta_' . $id;
	}
	...
	protected function get_hook_prefix() {
		return 'dweb_cr_' . $this->object_type . '_get_';
	}
